...
maltsev_admin = 402431402
danilovskiy_admin = 346573500
polirov_admin = 218714164  
...
Компания X занимается предоставлением программного обеспечения для банков и их поддержкой.
...
Ты обязательно указываешь причину, почему ты указал конкретного инженера.
Ты обязательно указываешь код инженера L2 в ответе.
Если есть несколько подходящих инженеров, то одного из них надо явно выделить в рекомендации.
"""}]
...
def fn_main_help(message):
    try:
        ...
        for i in admins:
            admin = i.get('admin')               
            bot.send_message(admin, 'Функция fn_main_help не работает корректно!', parse_mode='html', reply_markup=hideBoard)
        bot.send_message(message.chat.id, "Произошла ошибка! \nСообщение о некорректной работе отправлено в поддержку", parse_mode='html', reply_markup=hideBoard)
        pass
# start
...
def fn_main(message):
    try:
        ...
        for i in admins:
            admin = i.get('admin')               
            bot.send_message(admin, 'Функция fn_main не работает корректно!', parse_mode='html', reply_markup=hideBoard)
        bot.send_message(message.chat.id, "Произошла ошибка! \nСообщение о некорректной работе отправлено в поддержку", parse_mode='html', reply_markup=hideBoard)
        pass
...
def checking_access(message):
    ...
    try:
        ...
        for i in admins:
            admin = i.get('admin')               
            bot.send_message(admin, 'Функция checking_access не работает корректно!', parse_mode='html', reply_markup=hideBoard)
        bot.send_message(message.chat.id, "Произошла ошибка! \nСообщение о некорректной работе отправлено в поддержку", parse_mode='html', reply_markup=hideBoard)
        pass
#---------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
def start_access(message, phone):
    try:
        ...
        for i in admins:
            admin = i.get('admin')               
            bot.send_message(admin, 'Функция start_access не работает корректно!', parse_mode='html', reply_markup=hideBoard)
        bot.send_message(message.chat.id, "Произошла ошибка! \nСообщение о некорректной работе отправлено в поддержку", parse_mode='html', reply_markup=hideBoard)
        pass
...
def fn_main_contact(message):
    try:
        ...
        print('====================== user {} fn_main_contact end ======================'.format(message.from_user.id))    
    except Exception as e:
        admins = [            
            {'admin':'346573500'},
            {'admin':'218714164'},
        ...
        for i in admins:
            admin = i.get('admin')               
            bot.send_message(admin, 'Функция fn_main_contact не работает корректно!', parse_mode='html', reply_markup=hideBoard)
        bot.send_message(message.chat.id, "Произошла ошибка! \nСообщение о некорректной работе отправлено в поддержку", parse_mode='html', reply_markup=hideBoard)
        pass
#---------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
def fn3(message, v_phone, v_firstname, v_lastname):
    try:
        print('====================== user {} fn3 start ======================'.format(message.from_user.id))
        ...
        print('====================== user {} fn3 end ======================'.format(message.from_user.id))    
    except Exception as e:
        admins = [            
            {'admin':'346573500'},
            {'admin':'218714164'},
        ...
        for i in admins:
            admin = i.get('admin')               
            bot.send_message(admin, 'Функция fn3 не работает корректно!', parse_mode='html', reply_markup=hideBoard)
        bot.send_message(message.chat.id, "Произошла ошибка! \nСообщение о некорректной работе отправлено в поддержку", parse_mode='html', reply_markup=hideBoard)
        pass
#---------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
def fn_contact_find(message):
    try:
        print('====================== user {} fn_contact_find start ======================'.format(message.from_user.id))
        ...
        if "@" in mess:
            print('====================== user {} Выполняет поиск по E-mail ======================'.format(message.from_user.id))
            flag = 1
            for i in df1['Email']:
            ...
            print('====================== user {} Выполняет поиск по Номеру тлф ======================'.format(message.from_user.id))
            NUM_RE = re.compile(r".*(\d).*(\d).*(\d).*(\d).*(\d).*(\d).*(\d).*(\d).*(\d).*(\d).*")
            ph = lambda x: "+7" + ''.join(NUM_RE.match(x).groups())
            ...
            print('====================== user {} Выполняет поиск по Фамилии(RUS) ======================'.format(message.from_user.id))
            flag = 3
            ...
            print('====================== user {} Выполняет поиск по Фамилии(ENG) ======================'.format(message.from_user.id))
            flag = 4
            ...
            print(f1)
        if f1 == '' and flag == 0:
            print('======================  По запросу от user {} ничего не найдено ======================'.format(message.from_user.id))
        ...
        #если не нашли по атрибуту
            ...
            msg = bot.send_message(message.chat.id, f'Я не нашёл коллегу по <b>фамилии</b> <b>{message.text}</b> из запроса. Попробуем еще раз?', parse_mode='html', reply_markup=markup2)
            bot.register_next_step_handler(msg, fn3, '', '', '')
        print('====================== user {} fn_contact_find end ======================'.format(message.from_user.id))
    except Exception as e:
        admins = [            
            {'admin':'346573500'},
            {'admin':'218714164'},
        ...
        for i in admins:
            admin = i.get('admin')               
            bot.send_message(admin, 'Функция fn_contact_find не работает корректно!', parse_mode='html', reply_markup=hideBoard)
        bot.send_message(message.chat.id, "Произошла ошибка! \nСообщение о некорректной работе отправлено в поддержку", parse_mode='html', reply_markup=hideBoard)
        pass
#---------------------------------------------------------------------------------------------------------------------------------------------------------------------
#---------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
def fn_main_website(message):  
    try:
        print('====================== user {} fn_main_website start ======================'.format(message.from_user.id))    
        ...
        print('====================== user {} fn_main_website end ======================'.format(message.from_user.id))
    except Exception as e:
        admins = [            
            {'admin':'346573500'},
            {'admin':'218714164'},
        ...
        for i in admins:
            admin = i.get('admin')               
            bot.send_message(admin, 'Хендлер /website не работает корректно!', parse_mode='html', reply_markup=hideBoard)
        bot.send_message(message.chat.id, "Произошла ошибка! \nСообщение о некорректной работе отправлено в поддержку", parse_mode='html', reply_markup=hideBoard)
        pass
#---------------------------------------------------------------------------------------------------------------------------------------------------------------------
#---------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
def fn_main_calendar(message):
    try:
        print('====================== user {} fn_main_calendar start ======================'.format(message.from_user.id))
        ...
        if events == []:            
            ...
            for event in events:
                try:
                    print('====================== user {} Поиск встреч на сегодня start ======================'.format(message.from_user.id))
                    ...
                    print('====================== user {} Поиск встреч на сегодня end ======================'.format(message.from_user.id))
                except Exception as e:
                    admins = [            
                        {'admin':'346573500'},
                        {'admin':'218714164'},
                    ...
                    for i in admins:
                        admin = i.get('admin')               
                        bot.send_message(admin, 'Поиск встреч в календаре чатбота не работает корректно!', parse_mode='html', reply_markup=hideBoard)
                    bot.send_message(message.chat.id, "Произошла ошибка! \nСообщение о некорректной работе отправлено в поддержку", parse_mode='html', reply_markup=hideBoard)
                    pass
        ...
        if events == []:
            ...
            for event in events:
                try:
                    print('====================== user {} Поиск встреч на завтра start ======================'.format(message.from_user.id))
                    start = event["DTSTART"].dt
                    summary = event["SUMMARY"]
                    url = event["URL"]                  
                    lastmodified = event["LAST-MODIFIED"].dt
                    ...
                    button_text = (start.strftime('%d.%m %H:%M') + ' - ' + event["DTEND"].dt.strftime('%H:%M') + '. ' + str(summary or 'Нет названия')).ljust(100, ' ')
                    markup.add(types.InlineKeyboardButton(button_text, url=url)) 
                    print('====================== user {} Поиск встреч на завтра end ======================'.format(message.from_user.id))
                except Exception as e:
                    admins = [            
                        {'admin':'346573500'},
                        {'admin':'218714164'},
        ...
        print('====================== user {} fn_main_calendar end ======================'.format(message.from_user.id))          
    except Exception as e:
        admins = [            
            {'admin':'346573500'},
            {'admin':'218714164'},
        ...
        for i in admins:
            admin = i.get('admin')               
            bot.send_message(admin, 'Хендлер /calendar не работает корректно!', parse_mode='html', reply_markup=hideBoard)
        bot.send_message(message.chat.id, "Произошла ошибка! \nСообщение о некорректной работе отправлено в поддержку", parse_mode='html', reply_markup=hideBoard)
        pass
#---------------------------------------------------------------------------------------------------------------------------------------------------------------------
#---------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
def fn_main_wiki(message):
    try:
        print('====================== user {} fn_main_wiki start ======================'.format(message.from_user.id))
        lists = [ 
            {
        ...
        print('====================== user {} fn_main_wiki end ======================'.format(message.from_user.id))    
    except Exception as e:
        admins = [            
            {'admin':'346573500'},
            {'admin':'218714164'},
        ...
        for i in admins:
            admin = i.get('admin')               
            bot.send_message(admin, 'Хендлер /wiki не работает корректно!', parse_mode='html', reply_markup=hideBoard)
        bot.send_message(message.chat.id, "Произошла ошибка! \nСообщение о некорректной работе отправлено в поддержку", parse_mode='html', reply_markup=hideBoard)
        pass    
...
def fn_push_menu(message):
    ...
    print('====================== user {} fn_push_menu start ======================'.format(message.from_user.id))
    bords = [
    {
...
def fn_main_issues(message):
    ...
    for bord in bords:
        ...
        try:       
            ...
            for i in admins:
                admin = i.get('admin')               
                bot.send_message(admin, 'Портал {} не отвечает! Проверьте подключение к серверу'.format(url), parse_mode='html', reply_markup=hideBoard)
    ...
    print('====================== user {} fn_main_issues end ======================'.format(message.from_user.id))
...
def repeat_all_messages(message):
    print('====================== user {} repeat_all_messages start ======================'.format(message.from_user.id))
    import openai
    ...
    print('====================== user {} repeat_all_messages end ======================'.format(message.from_user.id))        


if __name__ == '__main__':
    print('0' + ' | ' + str('Start TG BOT') + ' | ' + str(' ') + ' | ' + str(' '))  
    print(f'Администраторы чатбота:\n','|', maltsev_admin,'|',danilovskiy_admin,'|',polirov_admin,'|',)
